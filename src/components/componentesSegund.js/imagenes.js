    ...
    return(
        <div>
            <div className="card cont" >
                  <img onClick={modalOpen} className="card-img-top im" src={"https://lista-de-tareas-production.up.railway.app/"+ id+ nombre}></img>
              ...
              <div className="card-body">
                 ...
                 <ReactModal isOpen={modal}  onRequestClose={modalClose} className="modContenedor" >
                    ...
                    <div className="conModal">
                        ...
                        <img  className="card-img-top mod" src={"https://lista-de-tareas-production.up.railway.app/"+ id+ nombre}></img>
                    </div>
